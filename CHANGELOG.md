...
- Enh: Remove custom `Application` DI container accessor and use global `Yii::$container`, applying `container` definitions/singletons only once per worker lifecycle (@terabytesoftw)
