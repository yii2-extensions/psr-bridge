...
- Bug #240: Add `Application::bootstrapContainer()` to initialize `Yii::$container` bindings before the first handled request for runtimes that resolve services during bootstrap (@terabytesoftw)
